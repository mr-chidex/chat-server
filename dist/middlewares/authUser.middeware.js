    ...
    auth(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                user = yield User_1.User.findOneBy({ id: decodeToken.userId });
            }
            catch (err) {
            ...
            if (user.token !== token) {
                return (0, utils_1.errorResponse)('Unauthorized Access: User logout', 403);
            }
            req.user = user;
            next();
        });
...
//# sourceMappingURL=authUser.middeware.js.map